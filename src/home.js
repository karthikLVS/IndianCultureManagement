...
export function loadModule(smid) {
    ...
    switch (smid) {
        ...
        case "M10101":
            ...
            break;
        case "K00101": // New case for Book Appointment
            module.src = "/Diwali1";
            titlebar.innerText = "Diwali";
            break;
        case "K00102": // New case for Book Appointment
            module.src = "/Holi";
            titlebar.innerText = "Holi";
            break;
        case "K00103": // New case for Book Appointment
            module.src = "/Ramzan";
            titlebar.innerText = "Ramzan";
            break;
        case "K00104": // New case for Book Appointment
            module.src = "/Christmas";
            titlebar.innerText = "Christmas";
            break;
        case "K00108": // New case for Book Appointment
            module.src = "/IndianFestivalCalendar";
            titlebar.innerText = "IndianFestivalCalendar";
            break;
        case "Z00101": // New case for Book Appointment
            module.src = "/tajmahal";
            titlebar.innerText = "Taj mahal";
            break;
        case "Z00102": // New case for Book Appointment
            module.src = "/jamamasjid";
            titlebar.innerText = "Jama Masjid";
            break;
        case "Z00103": // New case for Book Appointment
            module.src = "/redfort";
            titlebar.innerText = "Red Fort";
            break;
        case "Z00104": // New case for Book Appointment
            module.src = "/basilica_of_bom_jesus";
            titlebar.innerText = "Basilica Of Bom Jesus";
            break;
        case "Z00105": // New case for Book Appointment
            module.src = "/viewall";
            titlebar.innerText = "View All";
            break;
        case "L00101": // New case for Book Appointment
            module.src = "/andhra";
            titlebar.innerText = "Andhra Pradesh";
            break;
        case "Z00106":
            module.src = "/voteform";
            titlebar.innerText = "Voting Form";
            break;
        case "L00102": // New case for Book Appointment
            module.src = "/aruna";
